                                    ...
                                    <div class="add-product-box">
                                        ...
                                        <form class="form-horizontal" action="{{route('admin-sl-edit',$ad->id)}}" method="POST" enctype="multipart/form-data">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" name="title" id="edit_language" placeholder="Enter Name" required="" type="text" value="{{$ad->title}}">
                                            </div>
                                          </div>
                                    ...
                                    <input type="file" id="uploadFile" class="hidden" name="photo" value="">
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="add-product-footer">
                                                <button name="addProduct_btn" type="submit" class="btn add-product_btn">Update Expert</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
